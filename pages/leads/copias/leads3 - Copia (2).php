...
<head>
    ...
    <style>
        ...
        @media (max-width: 575px) { .lead-card-footer .btn-group { width: 100%; } .lead-card-footer .btn-group .btn { flex: 1; } .checkbox-group-mobile .form-check { flex: 1 1 calc(50% - 12px); min-width: auto; } }
    </style>
</head>
<body>
<div class="container">
    ...
    <div class="cards-mobile" style="display: none;">
        ...
        <div class="lead-card <?= $is_shared ? 'row-shared' : '' ?> <?= $classe_temperatura ?>" id="card-lead-<?= $l['id'] ?>">
            ...
            <div class="lead-card-body">
                ...
                <div class="lead-card-row">
                    <span class="lead-card-label">Contatar hoje</span>
                    <div class="form-check form-switch">
                        <input class="form-check-input toggle-hoje" type="checkbox" data-id="<?= $l['id'] ?>" <?= $l['contatar_hoje'] ? 'checked' : '' ?>>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    // ==========================================
    // FUNÇÃO: Resetar dias parados (ação)
    // ==========================================
    $(document).on('click', '.reset-dias', function() {
        ...
        $.post('leads3.php', { action: 'update_last_interaction', id: id }, function(res) {
            if (res.status === 'success') {
                // Atualiza o texto e a classe do badge para verde (0 dias)
                ...
                // Pequeno efeito visual no ícone
